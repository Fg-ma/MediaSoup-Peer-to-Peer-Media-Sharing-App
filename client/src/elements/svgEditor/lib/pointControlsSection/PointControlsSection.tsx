    ...
    >
      <FgButton
        ...
        clickFunction={(event) => {
          ...
          svgEditorController.deleteSelectedAndHovering();
        }}
        contentFunction={() => (
          <FgSVGElement
            src={trashIcon}
      ...
      <FgButton
        ...
        clickFunction={(event) => {
          event.stopPropagation();
          svgEditorController.swapControlType("inline");
        }}
        contentFunction={() => (
          <FgSVGElement
      ...
      <FgButton
        ...
        clickFunction={(event) => {
          event.stopPropagation();
          svgEditorController.swapControlType("inlineSymmetric");
        }}
        contentFunction={() => (
          <FgSVGElement
      ...
      <FgButton
        ...
        clickFunction={(event) => {
          event.stopPropagation();
          svgEditorController.swapControlType("free");
        }}
        contentFunction={() => (
          <FgSVGElement
