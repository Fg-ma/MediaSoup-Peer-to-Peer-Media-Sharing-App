...
export default function CreditPage() {
  ...
  return (
    <FgScrollbarElement
      ...
      contentContainerClassName="hide-scroll-bar w-screen h-screen flex flex-col space-y-[0.5%] p-[2%] overflow-y-auto overflow-x-hidden bg-fg-tone-black-1 items-center justify-start"
      content={
        <>
          <div className="font-Josefin text-4xl text-fg-white">
            Credit where credit is due
          </div>
          <div className="h-1 min-h-1 w-[90%] rounded-[2px] bg-fg-red"></div>
          <div className="flex w-full flex-col items-start justify-center space-y-[0.75%] pl-[2%] pt-[4%]">
            <CreditSection
              title="3D Models"
              creditItems={[
                <CreditItem
