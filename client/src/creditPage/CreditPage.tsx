    ...
    <FgScrollbarElement
      ...
      content={
        <div
          ...
          className='hide-scroll-bar w-screen h-screen flex flex-col space-y-[0.5%] p-[2%] overflow-y-auto overflow-x-hidden bg-fg-tone-black-1 items-center justify-start'
        >
          <div className='font-Josefin text-fg-white text-4xl'>
            Credit where credit is due
          </div>
          <div className='w-[90%] min-h-1 h-1 rounded-[2px] bg-fg-red'></div>
          <div className='w-full flex flex-col space-y-[0.75%] items-start justify-center pl-[2%] pt-[4%]'>
            <CreditSection
              title='3D Models'
              creditItems={[
                <CreditItem
                ...
                <CreditItem
                  ...
                  content=' - "Aviator Helmet With Goggles" used as "Aviator goggles"'
