...
import FgLowerVideoController from "./lib/LowerVideoController";
import { VideoOptions, Settings } from "../typeConstant";
...
import FgSettingsButton from "./lib/settingsButton/SettingsButton";
