...
(function ($, version) {
  ...
  var Slider = // encapsulate slider functionality for the ColorMap and ColorBar - could be useful to use a jQuery UI draggable for this with certain extensions
      function (bar, options) {
        var $this = this, // private properties, methods, and events - keep these variables and classes invisible to outside code
          ...
          range = function (name, value) {
            ...
            switch (name.toLowerCase()) {
              case "minx":
                newMinX =
                  (value && ((value.minX && value.minX | 0) || value | 0)) || 0;
                break;
              case "maxx":
                newMaxX =
                  (value && ((value.maxX && value.maxX | 0) || value | 0)) || 0;
                break;
              case "rangex":
              ...
              case "miny":
                newMinY =
                  (value && ((value.minY && value.minY | 0) || value | 0)) || 0;
                break;
              case "maxy":
                newMaxY =
                  (value && ((value.maxY && value.maxY | 0) || value | 0)) || 0;
                break;
              case "rangey":
        ...
        $.extend(
          true,
          $this, // public properties, methods, and event bindings - these we need to access from other controls
          {
            val: val,
            range: range,
            bind: bind,
    ...
    ColorValuePicker = // controls for all the input elements for the typing in color values
      function (picker, color, bindedHex, alphaPrecision) {
        var $this = this, // private properties and methods
            ...
            function (e) {
              ...
              switch (e.target) {
                ...
                case alpha && alpha.get(0):
                  ...
                  color.val(
                    "a",
                    Math.precision((alpha.val() * 255) / 100, alphaPrecision),
                    e.target
                  );
                  break;
                case hue.get(0):
                ...
                case saturation.get(0):
                  saturation.val(
                    setValueInRange.call($this, saturation.val(), 0, 100)
                  );
                  color.val("s", saturation.val(), e.target);
                  break;
                case value.get(0):
                ...
                case bindedHex && bindedHex.get(0):
                  ...
                  color.val(
                    "hex",
                    bindedHex.val() != "" ? bindedHex.val() : null,
                    e.target
                  );
                  break;
                case ahex && ahex.get(0):
                  ...
                  color.val(
                    "a",
                    ahex.val() != null ? parseInt(ahex.val(), 16) : null,
                    e.target
                  );
                  break;
              }
          ...
          colorChanged = function (ui, context) {
            ...
            if (alpha && context != alpha.get(0))
              alpha.val(
                all != null
                  ? Math.precision((all.a * 100) / 255, alphaPrecision)
                  : ""
              );
            ...
            if (
              context != hex.get(0) &&
              ((bindedHex && context != bindedHex.get(0)) || !bindedHex)
            )
              hex.val(all != null ? all.hex : "");
            if (
              bindedHex &&
              context != bindedHex.get(0) &&
              context != hex.get(0)
            )
        ...
        $.extend(
          true,
          $this, // public properties and methods
          {
            destroy: destroy,
          }
        );
  ...
  $.jPicker = {
        ...
        var $this = this,
          ...
          val = function (name, value, context) {
            ...
            switch (name.toLowerCase()) {
              case "ahex":
              case "hex":
                var ret = ColorMethods.hexToRgba(
                  (value && (value.ahex || value.hex)) || value || "00000000"
                );
                val.call(
                  $this,
                  "rgba",
    ...
    ColorMethods: {
      ...
      rgbaToHex: function (rgba) {
        return (
          this.intToHex(rgba.r) +
          this.intToHex(rgba.g) +
          this.intToHex(rgba.b) +
          this.intToHex(rgba.a)
        );
      },
  ...
  $.fn.jPicker = function (options) {
    ...
    return this.each(function () {
      ...
      var isLessThanIE7 =
          ...
          document.body.filters, // needed to run the AlphaImageLoader function for IE6
        container = null,
        colorMapDiv = null,
        colorBarDiv = null,
        ...
        updatePreview = function (ui) {
          try {
            ...
            setAlpha.call(
              $this,
              activePreview,
              (all && Math.precision((all.a * 100) / 255, 4)) || 0
            );
          } catch (e) {}
        },
        updateMapVisuals = function (ui) {
          switch (settings.color.mode) {
            case "h":
              setBG.call(
                $this,
                colorMapDiv,
                new Color({ h: ui.val("h") || 0, s: 100, v: 100 }).val("hex")
              );
              break;
            case "s":
            case "a":
            ...
            case "r":
              setAlpha.call(
                $this,
                colorMapL2,
                Math.precision(((ui.val("r") || 0) / 255) * 100, 4)
              );
              break;
            case "g":
              setAlpha.call(
                $this,
                colorMapL2,
                Math.precision(((ui.val("g") || 0) / 255) * 100, 4)
              );
              break;
            case "b":
              setAlpha.call(
                $this,
                colorMapL2,
                Math.precision(((ui.val("b") || 0) / 255) * 100)
              );
              break;
          }
          var a = ui.val("a");
          setAlpha.call(
            $this,
            colorMapL3,
            Math.precision(((255 - (a || 0)) * 100) / 255, 4)
          );
        },
          ...
          switch (settings.color.mode) {
            ...
            case "s":
              ...
              setAlpha.call(
                $this,
                colorBarL2,
                100 - (hva != null ? hva.v : 100)
              );
              setAlpha.call(
                $this,
                colorBarL5,
                Math.precision(((255 - ((hva && hva.a) || 0)) * 100) / 255, 4)
              );
              break;
            case "v":
              var hsa = ui.val("hsa"),
              ...
              setAlpha.call(
                $this,
                colorBarL5,
                Math.precision(((255 - ((hsa && hsa.a) || 0)) * 100) / 255, 4)
              );
              break;
            case "r":
            case "g":
            case "b":
              ...
              setAlpha.call(
                $this,
                colorBarL4,
                Math.precision((middle / 255) * 100, 4)
              );
              setAlpha.call(
                $this,
                colorBarL5,
                Math.precision(((255 - ((rgba && rgba.a) || 0)) * 100) / 255, 4)
              );
              break;
            case "a":
              var a = ui.val("a");
        ...
        setImg = function (img, src) {
          if (
            isLessThanIE7 &&
            (src.indexOf("AlphaBar.png") != -1 ||
              src.indexOf("Bars.png") != -1 ||
              src.indexOf("Maps.png") != -1)
          ) {
            img.attr("pngSrc", src);
            img.css({
        ...
        radioClicked = function (e) {
          $(this)
            .parents("tbody:first")
            .find('input:radio[value!="' + e.target.value + '"]')
            .removeAttr("checked");
        ...
        cancelClicked = function () {
          ...
          $.isFunction(cancelCallback) &&
            cancelCallback.call($this, color.active, cancelButton);
        },
        okClicked = function () {
          commitColor.call($this);
          settings.window.expandable && hide.call($this);
          $.isFunction(commitCallback) &&
            commitCallback.call($this, color.active, okButton);
        },
        ...
        currentColorChanged = function (ui, context) {
          ...
          setAlpha.call(
            $this,
            currentPreview,
            Math.precision(((ui.val("a") || 0) * 100) / 255, 4)
          );
        },
        expandableColorChanged = function (ui, context) {
          ...
          setAlpha.call(
            $this,
            iconAlpha,
            Math.precision(((255 - ((va && va.a) || 0)) * 100) / 255, 4)
          );
        ...
        documentMouseMove = function (e) {
          ...
          if (settings.window.expandable && !$.support.boxModel)
            container
              .prev()
              .css({ left: container.css("left"), top: container.css("top") });
          e.stopPropagation();
          e.preventDefault();
          return false;
        },
        ...
        show = function () {
          ...
          switch (settings.window.effects.type) {
            case "fade":
              container.fadeIn(
                settings.window.effects.speed.show,
                attachIFrame
              );
              break;
            case "slide":
        ...
        hide = function () {
          ...
          switch (settings.window.effects.type) {
            case "fade":
              container.fadeOut(
                settings.window.effects.speed.hide,
                removeIFrame
              );
              break;
            case "slide":
        ...
        initialize = function () {
          var win = settings.window,
            popup = win.expandable
              ? $($this).next().find(".Container:first")
              : null;
          ...
          var controlHtml =
            ...
            localization.tooltips.colors.newColor +
            '">&nbsp;</span><span class="Current" title="' +
            localization.tooltips.colors.currentColor +
            '">&nbsp;</span></div></div>' +
            localization.text.currentColor +
            '</td><td rowspan="9" class="method-button-color"><input type="button" class="Ok method-button" value="' +
            localization.text.ok +
            '" title="' +
            localization.tooltips.buttons.ok +
            '"/><input type="button" class="Cancel method-button" value="' +
            localization.text.cancel +
            '" title="' +
            localization.tooltips.buttons.cancel +
            '"/><div class="Grid">&nbsp;</div></td></tr><tr class="Hue"><td class="Radio"><label title="' +
            localization.tooltips.hue.radio +
            '"><input name="color_mode" type="radio" value="h"' +
            (settings.color.mode == "h" ? ' checked="checked"' : "") +
            '/>H</label></td><td class="Text"><input type="text" maxlength="3" value="' +
            (all != null ? all.h : "") +
            '" title="' +
            localization.tooltips.hue.textbox +
            '"/>&nbsp;º</td></tr><tr class="Saturation"><td class="Radio"><label title="' +
            localization.tooltips.saturation.radio +
            '"><input  name="color_mode" type="radio" value="s"' +
            (settings.color.mode == "s" ? ' checked="checked"' : "") +
            '/>S</label></td><td class="Text"><input type="text" maxlength="3" value="' +
            (all != null ? all.s : "") +
            '" title="' +
            localization.tooltips.saturation.textbox +
            '"/>&nbsp;%</td></tr><tr class="Value"><td class="Radio"><label title="' +
            localization.tooltips.value.radio +
            '"><input  name="color_mode" type="radio" value="v"' +
            (settings.color.mode == "v" ? ' checked="checked"' : "") +
            '/>L</label></td><td class="Text"><input type="text" maxlength="3" value="' +
            (all != null ? all.v : "") +
            '" title="' +
            localization.tooltips.value.textbox +
            '"/>&nbsp;%<br/><br/></td></tr><tr class="Red"><td class="Radio"><label title="' +
            localization.tooltips.red.radio +
            '"><input name="color_mode" type="radio" value="r"' +
            (settings.color.mode == "r" ? ' checked="checked"' : "") +
            '/>R</label></td><td class="Text"><input type="text" maxlength="3" value="' +
            (all != null ? all.r : "") +
            '" title="' +
            localization.tooltips.red.textbox +
            '"/></td></tr><tr class="Green"><td class="Radio"><label title="' +
            localization.tooltips.green.radio +
            '"><input  name="color_mode" type="radio" value="g"' +
            (settings.color.mode == "g" ? ' checked="checked"' : "") +
            '/>G</label></td><td class="Text"><input type="text" maxlength="3" value="' +
            (all != null ? all.g : "") +
            '" title="' +
            localization.tooltips.green.textbox +
            '"/></td></tr><tr class="Blue"><td class="Radio"><label title="' +
            localization.tooltips.blue.radio +
            '"><input  name="color_mode" type="radio" value="b"' +
            (settings.color.mode == "b" ? ' checked="checked"' : "") +
            '/>B</label></td><td class="Text"><input type="text" maxlength="3" value="' +
            (all != null ? all.b : "") +
            '" title="' +
            localization.tooltips.blue.textbox +
            '"/></td></tr><tr class="Alpha"><td class="Radio">' +
            (win.alphaSupport
              ? '<label title="' +
                localization.tooltips.alpha.radio +
                '"><input  name="color_mode" type="radio" value="a"' +
                (settings.color.mode == "a" ? ' checked="checked"' : "") +
                "/>A</label>"
              : "&nbsp;") +
            '</td><td class="Text">' +
            (win.alphaSupport
              ? '<input type="text" maxlength="' +
                (3 + win.alphaPrecision) +
                '" value="' +
                (all != null
                  ? Math.precision((all.a * 100) / 255, win.alphaPrecision)
                  : "") +
                '" title="' +
                localization.tooltips.alpha.textbox +
                '"/>&nbsp;%'
              : "&nbsp;") +
            '</td></tr><tr class="Hex"><td colspan="2" class="Text"><label title="' +
            localization.tooltips.hex.textbox +
            '">Hex<input type="text" maxlength="6" class="Hex" value="' +
            (all != null ? all.hex : "") +
            '"/></label>' +
            (win.alphaSupport
              ? '<input type="text" maxlength="2" class="AHex" value="' +
                (all != null ? all.ahex.substring(6) : "") +
                '" title="' +
                localization.tooltips.hex.alpha +
                '"/></td>'
              : "&nbsp;") +
            "</tr></tbody></table>";
          if (win.expandable) {
          ...
          var hex = all != null ? all.hex : null,
            ...
            button = tbody.find(".method-button-color");
          ...
          setAlpha.call(
            $this,
            currentPreview,
            Math.precision(color.current.val("a") * 100) / 255,
            4
          );
          okButton = button
            .find(".Ok:first")
            .bind("click touchstart", okClicked);
          cancelButton = button
            .find(".Cancel:first")
            .bind("click touchstart", cancelClicked);
          ...
          setTimeout(function () {
            ...
            setImg.call(
              $this,
              colorMapL3,
              images.clientPath + "map-opacity.png"
            );
            ...
            setImg.call(
              $this,
              colorBarL5,
              images.clientPath + "bar-opacity.png"
            );
            setImg.call($this, colorBarL6, images.clientPath + "AlphaBar.png");
            setImg.call(
              $this,
              preview.find("div:last"),
              images.clientPath + "preview-opacity.png"
            );
          }, 0);
          ...
          if (color.quickList && color.quickList.length > 0) {
            ...
            for (i = 0; i < color.quickList.length; i++) {
              ...
              if (
                (typeof color.quickList[i]).toString().toLowerCase() == "string"
              )
              ...
              html +=
                ...
                (quickHex
                  ...
                  : "background-image:url(" +
                    images.clientPath +
                    "NoColor.svg)") +
                (win.alphaSupport && alpha && alpha < 255
                  ? ";opacity:" +
                    Math.precision(alpha / 255, 4) +
                    ";filter:Alpha(opacity=" +
                    Math.precision(alpha / 2.55, 4) +
                    ")"
                  : "") +
                '">&nbsp;</span>';
            }
          ...
          if (win.expandable) {
            ...
            setAlpha.call(
              $this,
              iconAlpha,
              Math.precision(((255 - (all != null ? all.a : 0)) * 100) / 255, 4)
            );
            iconImage = $this.icon
              .find(".Image:first")
              .css({
                backgroundImage:
                  "url('" + images.clientPath + images.picker.file + "')",
              })
            ...
            moveBar = tbody
              .find(".Move:first")
              .bind("mousedown", moveBarMouseDown);
            color.active.bind(expandableColorChanged);
          } else show.call($this);
        },
        destroy = function () {
          container
            .find("td.Radio input  touchstart")
            .unbind("click", radioClicked);
        ...
        color = {
          active:
            (typeof settings.color.active).toString().toLowerCase() == "string"
              ? new Color({
                  ahex:
                    !settings.window.alphaSupport && settings.color.active
                      ? settings.color.active.substring(0, 6) + "ff"
                      : settings.color.active,
                })
              : new Color({
                  ahex:
                    !settings.window.alphaSupport &&
  ...
  $.fn.jPicker.defaults =
    /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
    {
      window: {
        title:
          null /* any title for the jPicker window itself - displays "Drag Markers To Pick A Color" if left null */,
        effects: {
      ...
      localization: {
        ...
        tooltips: {
          ...
          hue: {
            radio: "Hue color mode",
            textbox: "Hue (0-360&deg;)",
          },
          saturation: {
            radio: "Saturation color mode",
            textbox: "Saturation (0-100%)",
          },
          value: {
            radio: "Value color mode",
            textbox: "Value (0-100%)",
          },
          red: {
            radio: "Red color mode",
            textbox: "Red (0-255)",
          },
          green: {
            radio: "Green color mode",
            textbox: "Green (0-255)",
          },
          blue: {
            radio: "Blue color mode",
            textbox: "Enter A &ldquo;Blue&rdquo; Value (0-255)",
          },
          alpha: {
            radio: "Alpha color mode",
            textbox: "Alpha (0-100)",
          },
          hex: {
            textbox: "Hex (#000000-#ffffff)",
            alpha: "Alpha (#00-#ff)",
          },
        },
      },
