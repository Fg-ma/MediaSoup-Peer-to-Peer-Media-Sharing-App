...
(function () {
  ...
  jQuery.fn.jGraduate = function (options) {
    ...
    return this.each(function () {
      ...
      $.extend(
        true,
        $this, // public properties, methods, and callbacks
        {
          // make a copy of the incoming paint
          paint: new $.jGraduate.Paint({ copy: $settings.paint }),
          okCallback: ($.isFunction($arguments[1]) && $arguments[1]) || null,
          cancelCallback:
            ($.isFunction($arguments[2]) && $arguments[2]) || null,
        }
      );
      ...
      gradPicker.html(
        '<div id="' +
          id +
          '_jGraduate_Swatch" class="jGraduate_Swatch">' +
          '<h2 class="jGraduate_Title">' +
          $settings.window.pickerTitle +
          "</h2>" +
          '<div id="' +
          id +
          '_jGraduate_GradContainer" class="jGraduate_GradContainer"></div>' +
          '<div id="' +
          id +
          '_jGraduate_StopSlider" class="jGraduate_StopSlider"></div>' +
          "</div>" +
          ...
          '<input type="text" id="' +
          id +
          '_jGraduate_x1" size="3" title="Enter starting x value between 0.0 and 1.0"/>' +
          "<label> y:</label>" +
          '<input type="text" id="' +
          id +
          '_jGraduate_y1" size="3" title="Enter starting y value between 0.0 and 1.0"/>' +
          "</div>" +
          "</div>" +
          '<div class="jGraduate_StopSection">' +
          ...
          '<input type="text" id="' +
          id +
          '_jGraduate_x2" size="3" title="Enter ending x value between 0.0 and 1.0"/>' +
          "<label> y:</label>" +
          '<input type="text" id="' +
          id +
          '_jGraduate_y2" size="3" title="Enter ending y value between 0.0 and 1.0"/>' +
          "</div>" +
          "</div>" +
          "</div>" +
          ...
          '<input type="text" id="' +
          id +
          '_jGraduate_cx" size="3" title="Enter x value between 0.0 and 1.0"/>' +
          "<label> y:</label>" +
          '<input type="text" id="' +
          id +
          '_jGraduate_cy" size="3" title="Enter y value between 0.0 and 1.0"/>' +
          "</div>" +
          "</div>" +
          '<div class="jGraduate_StopSection">' +
          '<label class="jGraduate_Form_Heading">Focal Point</label>' +
          '<div class="jGraduate_Form_Section">' +
          '<label class="match-center"><input type="checkbox" checked="checked" id="' +
          id +
          '_jGraduate_match_ctr"/> Match center</label><br/>' +
          "<label>x:</label>" +
          '<input type="text" id="' +
          id +
          '_jGraduate_fx" size="3" title="Enter x value between 0.0 and 1.0"/>' +
          "<label> y:</label>" +
          '<input type="text" id="' +
          id +
          '_jGraduate_fy" size="3" title="Enter y value between 0.0 and 1.0"/>' +
          "</div>" +
          "</div>" +
          "</div>" +
          ...
          '<div id="' +
          id +
          '_jGraduate_Radius" class="jGraduate_SliderBar jGraduate_Radius" title="Click to set radius">' +
          '<img id="' +
          id +
          '_jGraduate_RadiusArrows" class="jGraduate_RadiusArrows" src="' +
          $settings.images.clientPath +
          'rangearrows2.svg" width="9" height="20">' +
          "</div>" +
          '<label><input type="text" id="' +
          id +
          '_jGraduate_RadiusInput" size="3" value="100"/>%</label>' +
          "</div>" +
          '<div class="jGraduate_Slider jGraduate_EllipField jGraduate_rg_field">' +
          '<label class="prelabel">Ellip:</label>' +
          '<div id="' +
          id +
          '_jGraduate_Ellip" class="jGraduate_SliderBar jGraduate_Ellip" title="Click to set Ellip">' +
          '<img id="' +
          id +
          ...
          '<label><input type="text" id="' +
          id +
          '_jGraduate_EllipInput" size="3" value="0"/>%</label>' +
          "</div>" +
          '<div class="jGraduate_Slider jGraduate_AngleField jGraduate_rg_field">' +
          '<label class="prelabel">Angle:</label>' +
          '<div id="' +
          id +
          '_jGraduate_Angle" class="jGraduate_SliderBar jGraduate_Angle" title="Click to set Angle">' +
          '<img id="' +
          id +
          ...
          '<label><input type="text" id="' +
          id +
          '_jGraduate_AngleInput" size="3" value="0"/>º&nbsp;</label>' +
          "</div>" +
          '<div class="jGraduate_Slider jGraduate_OpacField">' +
          '<label class="prelabel">Opac:</label>' +
          '<div id="' +
          id +
          '_jGraduate_Opac" class="jGraduate_SliderBar jGraduate_Opac" title="Click to set Opac">' +
          '<img id="' +
          id +
          ...
          '<label><input type="text" id="' +
          id +
          '_jGraduate_OpacInput" size="3" value="100"/>%</label>' +
          "</div>" +
          "</div>" +
          ...
          attr_input[attr] = $("#" + id + "_jGraduate_" + attr)
            ...
            .change(function () {
              ...
              if (!(attr[0] === "f" && !showFocus)) {
                if (
                  (isRadial && curType === "radialGradient") ||
                  (!isRadial && curType === "linearGradient")
                ) {
      ...
      function mkStop(n, color, opac, sel, stop_elem) {
        var stop =
          ...
          mkElem(
            "stop",
            { "stop-color": color, "stop-opacity": opac, offset: n },
            curGradient
          );
        if (stop_elem) {
            ...
            $("#" + id + "_jGraduate_stopPicker")
              ...
              .jPicker(
                ...
                function (color, arg2) {
                  ...
                  stopColor = color.val("hex")
                    ? "#" + color.val("hex")
                    : "rgba(255,255,255,0)";
                  stopOpacity =
                    color.val("a") !== null ? color.val("a") / 256 : 1;
      ...
      function selectStop(item) {
        ...
        item.setAttribute("stroke", "#d40213");
        cur_stop = item;
      ...
      var spreadMethodOpt = gradPicker
        .find(".jGraduate_spreadMethod")
        .change(function () {
      ...
      color =
        $this.paint.solidColor === "none"
          ? ""
          : $this.paint.solidColor + thisAlpha;
      ...
      colPicker.jPicker(
        ...
        function (color) {
          ...
          $this.paint.alpha = color.val("ahex")
            ? Math.round((color.val("a") / 255) * 100)
            : 100;
      ...
      tabs.on("click touchstart", function () {
        ...
        if (type === "rg" || type === "lg") {
          const isRadialUserSpaceOnUse =
            $("#color_picker").attr("data-radialUserSpace") === "true";
          $("#color_picker").toggleClass(
            "radialUserSpace",
            isRadialUserSpaceOnUse && type === "rg"
          );
          // Show/hide appropriate fields
          $(".jGraduate_" + type + "_field").show();
          $(".jGraduate_" + (type === "lg" ? "rg" : "lg") + "_field").hide();

          $("#" + id + "_jgraduate_rect")[0].setAttribute(
            "fill",
            "url(#" + id + "_" + type + "_jgraduate_grad)"
          );
          ...
          $("#" + id + "_jGraduate_OpacInput")
            .val($this.paint.alpha)
            .change();
          ...
          showFocus =
            type === "rg" &&
            curGradient.getAttribute("fx") != null &&
            !(cx == fx && cy == fy);
