...
(function () {
  ...
  var svgWhiteList_ = {
    ...
    feMerge: ["class", "color-interpolation-filters", "id", "requiredFeatures"],
    feMergeNode: [
      "class",
      "color-interpolation-filters",
      "id",
    ...
    feImage: ["result", "x", "y", "width", "height", "id"],
    feComponentTransfer: ["in", "id"],
    feFuncR: ["type", "tableValues", "id"],
    feFuncG: ["type", "tableValues", "id"],
    feFuncB: ["type", "tableValues", "id"],
    animate: ["attributeName", "values", "dur", "repeatCount", "id"],
    animateTransform: [
      "attributeName",
      "type",
      "values",
    ...
    feMorphology: ["operator", "radius", "in", "result", "id"],
    feFuncA: ["type", "tableValues", "id"],
    stop: ["stop-color", "offset", "stop-opacity", "id"],
    filter: [
      "class",
      "color-interpolation-filters",
      "filterRes",
  ...
  svgedit.sanitize.svgWhiteList = function () {
    return svgWhiteList_;
  };
  ...
  svgedit.sanitize.sanitizeSvg = function (node) {
    ...
    if (allowedAttrs != undefined) {
      ...
      while (i--) {
        ...
        if (
          !(
            allowedAttrsNS.hasOwnProperty(attrLocalName) &&
            attrNsURI == allowedAttrsNS[attrLocalName] &&
            attrNsURI != xmlnsns
          ) &&
