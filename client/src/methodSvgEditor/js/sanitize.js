...
(function () {
  ...
  var svgWhiteList_ = {
    ...
    feImage: ["result", "x", "y", "width", "height"],
    feComponentTransfer: ["in"],
    feFuncR: ["type", "tableValues"],
    feFuncG: ["type", "tableValues"],
    feFuncB: ["type", "tableValues"],
    animate: ["attributeName", "values", "dur", "repeatCount"],
    animateTransform: ["attributeName", "type", "values", "dur", "repeatCount"],
    feMorphology: ["operator", "radius", "in", "result"],
