...
export default function GlassesButton({
  ...
  const streamEffects = userStreamEffects.current.image[imageId].glasses;
  const effectsStyles = userEffectsStyles.current.image[imageId].glasses;
  ...
  const holdFunction = async (event: PointerEvent) => {
    ...
    const effectType = target.dataset
      .imageEffectsButtonValue as GlassesEffectTypes;
    if (
      ...
      await lowerImageController.handleImageEffect("glasses", streamEffects);
    }
            ...
            <FgButton
              ...
              contentFunction={() => (
                <div
                  ...
                  data-image-effects-button-value={glasses}
                >
                  <FgImageElement
                    src={effect.image}
