...
import { HideBackgroundEffectTypes } from "../context/streamEffectsContext/typeConstant";
...
const assetMeshes: MeshesData = {
  ...
  masks: {
    alienMask: {
      ...
      initScale: [4.25, 4, 4],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/alienMask.mp3",
    ...
    baseMask: {
      ...
      initScale: [0, 0, 0],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    clownMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/clownMask.mp3",
    ...
    creatureMask: {
      ...
      initScale: [3.75, 3.75, 3.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/creatureMask.mp3",
    ...
    cyberMask: {
      ...
      initScale: [4.25, 4, 4],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/cyberMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    darkKnightMask: {
      defaultMeshPlacement: "eyesCenter",
    ...
    demonMask: {
      ...
      initScale: [3.75, 3.75, 3.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/demonMask.mp3",
      transforms: { offsetX: 0, offsetY: -0.5 },
    },
    gasMask1: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/gasMask1.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    gasMask2: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [3.25, 3.25, 3.25],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/gasMask2.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    gasMask3: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [3.25, 3.25, 3.25],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/gasMask3.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    gasMask4: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [3.25, 3.25, 3.25],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/gasMask4.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    masqueradeMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [5, 5, 5],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/masqueradeMask.mp3",
      transforms: { offsetX: 0, offsetY: -0.5 },
    },
    metalManMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [4, 4, 4],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/metalManMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    oniMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/oniMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    plagueDoctorMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [4.25, 4, 4],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/plagueDoctorMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    sixEyesMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [3.25, 3.25, 3.25],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/sixEyesMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    tenguMask: {
      defaultMeshPlacement: "eyesCenter",
    ...
    threeFaceMask: {
      ...
      initScale: [3, 3, 3],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/threeFaceMask.mp3",
      transforms: { offsetX: 0, offsetY: -0.5 },
    },
    weldingMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [3.25, 3.25, 3.25],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/weldingMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    woodlandMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/woodlandMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    woodPaintedMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [4, 4, 4],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/woodPaintedMask.mp3",
      transforms: { offsetX: 0, offsetY: -0.5 },
    },
    zombieMask: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [4.5, 4.25, 4.25],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/masks/zombieMask.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
  },
  glasses: {
    ...
    AmericaGlasses: {
      ...
      initScale: [1.75, 1.75, 1.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/AmericaGlasses.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    aviatorGoggles: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [1.75, 1.75, 1.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/aviatorGoggles.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    bloodyGlasses: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [1.75, 1.75, 1.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/bloodyGlasses.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    eyeProtectionGlasses: {
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/eyeProtectionGlasses.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    glasses1: {
      defaultMeshPlacement: "eyesCenter",
    ...
    memeGlasses: {
      ...
      initScale: [1.75, 1.75, 1.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/memeGlasses.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    militaryTacticalGlasses: {
      ...
      initScale: [2, 2, 2],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/militaryTacticalGlasses.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    steampunkGlasses: {
      defaultMeshPlacement: "eyesCenter",
      ...
      initScale: [1.75, 1.75, 1.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/steampunkGlasses.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    threeDGlasses: {
      defaultMeshPlacement: "eyesCenter",
    ...
    toyGlasses: {
      ...
      initScale: [1.75, 1.75, 1.75],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/glasses/toyGlasses.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    shades: {
      defaultMeshPlacement: "eyesCenter",
  ...
  hats: {
    ...
    bicycleHelmet: {
      ...
      initScale: [2, 2, 2],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/bicycleHelmet.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    captainsHat: {
      defaultMeshPlacement: "forehead",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/captainsHat.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    chefHat: {
      defaultMeshPlacement: "forehead",
    ...
    chickenHat: {
      ...
      initScale: [2.5, 2.5, 2.5],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/chickenHat.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    deadManHat: {
      defaultMeshPlacement: "forehead",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/deadManHat.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    dogEars: {
      defaultMeshPlacement: "forehead",
      ...
      initScale: [1.25, 1.25, 1.25],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/dogEars.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    flatCap: {
      defaultMeshPlacement: "forehead",
    ...
    hardHat: {
      ...
      initScale: [2.5, 2.5, 2.5],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/hardHat.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    hopliteHelmet: {
      defaultMeshPlacement: "nose",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/hopliteHelmet.mp3",
      transforms: { offsetX: 0, offsetY: 6 },
    },
    militaryHat: {
      defaultMeshPlacement: "forehead",
    ...
    rabbitEars: {
      ...
      initScale: [1.5, 1.5, 1.5],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/rabbitEars.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    santaHat: {
      defaultMeshPlacement: "forehead",
      ...
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/santaHat.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    seamanHat: {
      defaultMeshPlacement: "forehead",
      ...
      initScale: [1.875, 1.875, 1.875],
      initRotation: [0, 0, 0],
      soundEffectPath: "/audioAssets/hats/seamanHat.mp3",
      transforms: { offsetX: 0, offsetY: 0 },
    },
    stylishHat: {
      defaultMeshPlacement: "forehead",
