...
class TableVideoAudioMedia {
  ...
  constructor(
    ...
    this.staticContentEffects.current.video[this.videoId].audio =
  ...
  changeEffects = (
    ...
    if (!blockStateChange) {
      ...
      for (const oldEffect in this.staticContentEffects.current.video[
        this.videoId
      ].audio) {
        if (
          this.staticContentEffects.current.video[this.videoId].audio[
...
export default TableVideoAudioMedia;
