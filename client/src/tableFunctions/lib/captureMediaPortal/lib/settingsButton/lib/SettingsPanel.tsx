...
export default function SettingsPanel({
  ...
  return (
    <FgPortal
      ...
      className="flex pointer-events-auto z-settings-panel h-max max-h-80 w-64 rounded-md border-2 border-fg-white bg-fg-tone-black-2 p-2 font-K2D text-base text-fg-white shadow-md shadow-fg-tone-black-8"
