...
import TableBabylonScene from "../../tableBabylon/BabylonScene";
...
export default function LittleBuddiesLayer({
  ...
  useEffect(() => {
    if (canvasRef.current) {
      new TableBabylonScene(canvasRef.current, undefined);
    }
  }, []);
  ...
  return (
    ...
    >
      ...
      />
      <canvas ref={babylonCanvasRef} className="h-full w-full" />
    </div>
  );
}
